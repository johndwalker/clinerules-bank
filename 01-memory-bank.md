...
When plannning a new feature, follow the planning guidelines outlined in [Project Management](./04-project-management#planning).
...
When implementing a planned feature, follow the execution guidelines outlined in [Project Management](./04-project-management#execute-the-plan).
